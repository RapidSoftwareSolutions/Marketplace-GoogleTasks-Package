...
$app->post('/api/GoogleTasks/moveTask', function ($request, $response) {
    ...
    $optionalParams = ['parent'=>'parent','previous'=>'previous','fields'=>'fields'];
    $bodyParams = [
    ...
    $query_str = "https://www.googleapis.com/tasks/v1/lists/{$data['tasklistId']}/tasks/{$data['taskId']}/move";
